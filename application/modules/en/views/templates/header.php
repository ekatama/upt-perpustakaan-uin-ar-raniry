                    ...
                    <div class="kingster-top-search-wrap">
                        ...
                        <div class="kingster-top-search-row">
                            <div class="kingster-top-search-cell">
                                <form role="search" method="get" class="search-form" action="<?= base_url("en/")?>search">
                                    <input type="text" class="search-field kingster-title-font" placeholder="Search activities, events.." name="search">
                    ...
                    <div class="kingster-mobile-menu"><a class="kingster-mm-menu-button kingster-mobile-menu-button kingster-mobile-button-hamburger" href="#kingster-mobile-menu"><span></span></a>
                        <div class="kingster-mm-menu-wrap kingster-navigation-font" id="kingster-mobile-menu" data-slide="right">
                            <ul id="menu-main-navigation" class="m-menu">
                                ...
                                <li class="menu-item <?= ( $title == "regulasi") ? 'current-menu-item' : '' ; ?> menu-item-has-children"><a href="<?= site_url("en/");?>regulasi?module=regulasi">Regulation</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="<?= site_url("en/");?>regulasi?module=policy">Policy</a></li>
                                        <li class="menu-item"><a href="<?= site_url("en/");?>regulasi?module=uu-perpus">Law on Library Regulations</a></li>
                                    </ul>
                                </li>
            ...
            <div class="kingster-navigation kingster-item-pdlr clearfix ">
                <div class="kingster-main-menu" id="kingster-main-menu">
                    <ul id="menu-main-navigation-1" class="sf-menu">
                        ...
                        <li class="menu-item <?= ( $title == "regulasi") ? 'current-menu-item' : '' ; ?> menu-item-has-children kingster-normal-menu"><a href="<?= site_url("en/");?>regulasi?module=regulasi" class="sf-with-ul-pre">Regulation</a>
                            <ul class="sub-menu">
                                <li class="menu-item " data-size="60"><a href="<?= site_url("en/");?>regulasi?module=policy">Policy</a></li>
                                <li class="menu-item" data-size="60"><a href="<?= site_url("en/");?>regulasi?module=uu-perpus">Law on Library Regulations</a></li>
                            </ul>
                        </li>
