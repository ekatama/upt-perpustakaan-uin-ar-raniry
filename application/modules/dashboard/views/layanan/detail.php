...
<div class="container-fluid">
    ...
    <div class="col-md-6">
      <div class="card-body shadow bg-white">
        ...
        <div class="form-group" >
            ...
            <input type="text" class="form-control" id="title" name="title" value="<?= $layanan['title'];?>" required>
            <div class="invalid-feedback">
            Judul harus diisi.
            </div>
        </div>
    ...
    <div class="col-md-12 mt-4">
      ...
      <div class="form-group">
            ...
            <input type="text" class="form-control" id="jadwal" name="jadwal" value="<?= $layanan['jadwal'];?>" required>
            <div class="invalid-feedback">
            Jadwal harus diisi.
            </div>
