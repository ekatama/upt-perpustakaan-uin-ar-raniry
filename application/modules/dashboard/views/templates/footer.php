...
<footer class="sticky-footer bg-white mt-5">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; UPT Perpustakaan UIN Ar-Raniry</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
 ...
 <script src="https://cdn.jsdelivr.net/npm/bs-custom-file-input/dist/bs-custom-file-input.min.js"></script> 
  ...
  <!-- Drag n drop script -->
  <script src="<?= base_url('assets/dashboard/js/dragndrop/dropzone-amd-module.min.js'); ?>"> </script>

  <!-- SweetAlert script-->
  <script src="<?= base_url('assets/dashboard/js/sweetalert/sweetalert2.all.min.js'); ?>"></script>
