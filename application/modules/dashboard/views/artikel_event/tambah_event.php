<div class="container">
      <div class="row">
        <div class="col-md-6">
          <a class='btn btn-success' href="<?= base_url(); ?>index.php/dashboard/artikel_event/index"><i class="fas fa-chevron-left"></i> Artikel & Event</a>
        </div>
      </div>
  </div>
          ...
          <div class="col-md-12">
            <form action="" method="post" class="needs-validation" novalidate>
              ...
              <div class="form-group d-flex flex-row-reverse">
                <button type="submit" class='btn btn-success' href="">Posting Event</button>
