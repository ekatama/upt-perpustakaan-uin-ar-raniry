<div class="container">
      <div class="row">
        <div class="col-md-6">
          <a class='btn btn-primary' href="<?= base_url(); ?>index.php/dashboard/regulasi/index"><i class="fas fa-chevron-left"></i> Regulasi</a>
        </div>
      </div>
  </div>

<form enctype="multipart/form-data" action="<?= base_url('index.php/dashboard/regulasi/prosesTambahFile');?>" method="post" class="needs-validation" novalidate>
<div class="container">
  <div class="row mt-5">
      <div class="col-md-6">
