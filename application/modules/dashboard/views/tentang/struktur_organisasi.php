  ...
  <div class="row mt-5">
      <div class="col-md-6">
        <div class="card-body shadow bg-white">
          <div class="flash-data-tentang" data-flashdata="<?= $this->session->flashdata('flash');?>"></div>
            ...
            <img src="<?= base_url('assets/uploads/struktur/');?><?=$tentang['konten'];?>" alt="Foto Struktur Organisasi" style="width:60%; margin-bottom:15px;">
      ...
      <div class="col-md-6">
        <div class="card-body shadow bg-white">
            ...
            <img src="<?= base_url('assets/uploads/struktur/');?><?=$tentang['content'];?>" alt="Foto Struktur Organisasi" style="width:60%; margin-bottom:15px;">
              <div class="form-group">
