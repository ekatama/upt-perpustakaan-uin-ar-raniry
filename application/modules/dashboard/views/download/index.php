            ...
            <div class="col-md-4">
              <div class="card shadow mb-4">
                  <div class="card-body py-3">
                    <a href="<?= base_url(); ?>index.php/dashboard/download/detail" style='text-decoration: none'><h6 class="mt-0 font-weight-bold text-primary"><?=word_limiter($dwnld['judul'],7," ...");?></h6></a>
                    </div>
